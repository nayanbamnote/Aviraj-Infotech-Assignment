  ...
  return (
    <Tag
      ...
      className={cn(
        ...
        forceDarkMode && "bg-white/20",
        containerClassName
      )}
      style={{ borderColor: '#333333' }} // Set border color to #333333
      {...props}
    >
      <div
        className={cn(
          "w-auto z-10 px-4 py-2 rounded-[inherit]",
          forceDarkMode ? "text-white bg-black" : "text-black bg-white",
          className
        )}
      >
        {children}
      ...
      <div 
        className={cn(
          ...
          forceDarkMode ? "bg-black" : "bg-white"
        )}
      />
    </Tag>
  );
